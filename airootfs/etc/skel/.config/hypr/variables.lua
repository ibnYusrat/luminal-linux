...
return {
    ...
    windowGapsIn               = 5,
    windowGapsOut              = 10,
    singleWindowGapsOut        = { top = "10%", right = "22%", bottom = "10%", left = "22%" },
    ...
    kbGapsDecrease             = { "SUPER + ALT + Minus", "SUPER + SHIFT + G" },
    kbGapsIncrease             = { "SUPER + ALT + Equal", "SUPER + G" },
    ...
    kbScreenshotAreaClipboard  = "CTRL + ALT + SHIFT + 4",
    kbRecord                   = "CTRL + ALT + R",
