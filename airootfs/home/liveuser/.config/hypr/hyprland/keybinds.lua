...
for _, dir in ipairs({ "left", "right", "up", "down" }) do
    create_bind("CTRL + SHIFT + " .. dir, hl.dsp.focus({ direction = dir }))
...
create_bind(vars.kbGapsDecrease, fn.adjust_gaps(-2), repeating)
create_bind(vars.kbGapsIncrease, fn.adjust_gaps(2), repeating)
...
create_bind(vars.kbScreenshotAreaClipboard, hl.dsp.exec_cmd("~/.config/hypr/screenshot_area.sh"), locked)
...
-- Wallpaper Mode Shortcuts (1: Always Playing, 2: Smart Auto-Pause, 3: Static/Paused)
create_bind("SUPER + SHIFT + 8", hl.dsp.exec_cmd("~/.config/hypr/set_wallpaper.sh 1"))
create_bind("SUPER + SHIFT + 9", hl.dsp.exec_cmd("~/.config/hypr/set_wallpaper.sh 2"))
create_bind("SUPER + SHIFT + 0", hl.dsp.exec_cmd("~/.config/hypr/set_wallpaper.sh 3"))
